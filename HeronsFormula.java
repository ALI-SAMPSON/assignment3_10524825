...
public class HeronsFormula
{
	public static void main( String[] args )
	{
		...
		i = triangleArea(3, 3, 3);
		System.out.println("A triangle with sides 3,3,3 has an area of " + i );

		i = triangleArea(3, 4, 5);
		System.out.println("A triangle with sides 3,4,5 has an area of " + i );
 
		i = triangleArea(7, 8, 9);
		System.out.println("A triangle with sides 7,8,9 has an area of " + i );
